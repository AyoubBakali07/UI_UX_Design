...
@section('content')
    <div class="mb-8">
        <div class="relative mb-6">
            <input type="text" placeholder="  Rechercher une formation..." class="w-full px-4 pl-10 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
